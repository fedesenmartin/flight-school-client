...
function ResponsiveDrawer(props) {
  ...
  const [selectedContent, setSelectedContent] = React.useState('Flights'); // State for selected content
  ...
  const handleMenuClick = (content) => {
    setSelectedContent(content); // Update selected content on menu click
    setMobileOpen(false); // Optionally close drawer after selection
  };
  ...
  const drawer = (
    <div>
      ...
      <Divider />
      <List>
        {['Actividad de Vuelo', 'Pilotos', 'Aviones', 'Finanzas'].map((text, index) => (
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        {selectedContent === 'Actividad de Vuelo' && <DataGridDemo setSelectedContent={setSelectedContent}></DataGridDemo>}
